...
! function() {
    ...
    var a, t = function(e, i) {
        ...
        function p(e) { e.originalEvent && (e = e.originalEvent);
            ...
            if (!(e.shiftKey || e.altKey || e.ctrlKey || e.metaKey || document.activeElement && document.activeElement.nodeName && ("input" === document.activeElement.nodeName.toLowerCase() || "textlocation" === document.activeElement.nodeName.toLowerCase()))) {
        ...
        if (b.params = i, b.originalParams = f, b.classNames = [], "undefined" != typeof a && "undefined" != typeof r && (a = r), ("undefined" != typeof a || (a = "undefined" == typeof r ? window.Dom7 || window.Zepto || window.jQuery : r)) && (b.$ = a, b.currentBreakpoint = void 0, b.getActiveBreakpoint = function() {
            ...
            var S, C, z, M, E, P, k, I, L, B, D = "input, select, textlocation, button",
                H = Date.now(),
                A = [];
...
jQuery(document).ready(function () {
    ...
    jQuery('a.coffee-team-member-det').click(function () {
        event.preventDefault();
