...
jQuery(document).ready(function () {
    ...
    function automobile_inv_elem_view_change(type_slug) {
        ...
        if (type_slug == 'icon') {
            jQuery('.cs-not-fancy-view-location-inv').hide();
            jQuery('.cs-not-slider-view-location-inv').show();
        } else {
            jQuery('.cs-not-fancy-view-location-inv').show();
            jQuery('.cs-not-slider-view-location-inv').hide();
        }

    }

    jQuery('input,textlocation').on('focus', function () {
 ...
 * Post like Counter 
 * --------------------------------------------------------------------------- */
function coffeebakery_post_likes_count(admin_url, id, obj) {
    "use strict";

    var dataString = 'post_id=' + id + '&action=coffeebakery_post_likes_count';
...
function coffeebakery_show_response_theme(loader_data, loading_element) {

    jQuery(".coffeebakery_loader").hide();
    jQuery("#growls").removeClass('coffeebakery_element_growl');
    ...
    if (loader_data != 'undefined' && loader_data != '') {
        ...
        if (loader_data.type != 'undefined' && loader_data.type == 'error') {
            ...
            if (loading_element != 'undefined' && loading_element != undefined && loading_element != '') {
                ...
                jQuery("#growls").addClass('coffeebakery_element_growl');
...
jQuery(document).ready(function ($) {
    if (jQuery(".coffeebakery-fancy-menu li.current-menu-parent a").length > 0) {
        jQuery(".coffeebakery-fancy-menu li.current-menu-parent a").click();
    } else if (jQuery(".coffeebakery-fancy-menu li").first().children('ul.sub-menu').length > 0) {
        jQuery(".coffeebakery-fancy-menu li").first().children('ul.sub-menu').slideDown();
        jQuery(".coffeebakery-fancy-menu li").first().addClass('active');
    }
    /*Back To Top Start*/
